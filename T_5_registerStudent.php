<html>
    ...
    <body class="register-student-container">
        <div class="container">
        <div class="row pt-5">
                    <div class="col-12">
                ...
                <div class="row justify-content-center">
                    <!-- <div class="col-md-6 register-student-box mx-4 mt-3 rounded">
                    ...
                    <!-- </div> -->
                    <div class="col-12 upload-student-image-box mx-4 mt-3 rounded">
